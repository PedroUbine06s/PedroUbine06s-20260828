  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'colaboradores',
        loadComponent: () =>
          import('./features/colaboradores/colaboradores-lista.component').then(
            m => m.ColaboradoresListaComponent
          )
      },
      {
        path: 'unidades',
        loadComponent: () =>
          import('./features/unidades/unidades-lista.component').then(m => m.UnidadesListaComponent)
      }
